...
class Stage extends FlxGroup
{
	...
	public function reloadStageFromSong(song:String = "test"):Void
	{
		...
		stageList = switch(song)
		{
			...
			case "unnecessary-call": ["ididyourmomlastnight"];
	...
	public function reloadStage(curStage:String = "")
	{
		...
		switch(curStage)
		{
			...
			case "ididyourmomlastnight":
				PlayState.defaultCamZoom = 1.5;
				PlayState.camFollow.x = 650;
				...
				divide.animation.addByPrefix('idle',  'lightning thing', 24, true);
				divide.animation.play('idle');
				foreground.add(divide);
